...
def run_toolkit(method_name,model_name, dataset_name, augment_method, use_llm=False, example_num=0, config_dict=None):
    """
    Run GEC toolkit
    """
    ...
    if use_llm:
        ...
        if method_name == 'OCR' or method_name == 'YOLO_CLIP' or method_name == 'text':
            dataset_name = dataset_name + '_' + method_name
        if model_name == 'Syngec':
            print('Please do above ')
            print('cd /home/xiaoman/project/gec/HandwrittenGEC/gectoolkit/properties/model/SynGEC/preprocess/bash/chinese_exp/')
            print('')
