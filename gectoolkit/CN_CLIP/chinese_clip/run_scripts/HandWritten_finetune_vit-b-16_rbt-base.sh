...
# Command: bash run_scripts/HandWritten_finetune_vit-b-16_rbt-base.sh ${DATAPATH}
...
# data options
train_data=${DATAPATH}/datasets/HandWritten/lmdb/train
val_data=${DATAPATH}/datasets/HandWritten/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=HandWritten_finetune_vit-b-16_roberta-base_bs128_8gpu
