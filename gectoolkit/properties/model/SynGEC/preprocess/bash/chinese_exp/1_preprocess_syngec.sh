...
FAIRSEQ_DIR="../../../../../../model/SynGEC/src/src_syngec/fairseq2/fairseq_cli"
...
TRAIN_SRC_FILE=../../preprocess_data/${dataset}/trainset/src.txt
TRAIN_TGT_FILE=../../preprocess_data/${dataset}/trainset/tgt.txt
VALID_SRC_FILE=../../preprocess_data/${dataset}/validset/src.txt
VALID_TGT_FILE=../../preprocess_data/${dataset}/validset/tgt.txt

wc -l ../../preprocess_data/${dataset}/trainset/src.txt
wc -l ../../preprocess_data/${dataset}/trainset/tgt.txt
...
python $FAIRSEQ_DIR/preprocess.py --source-lang src --target-lang tgt \
       --user-dir ../../../../../../model/SynGEC/src/src_syngec/syngec_model \
...
### File path
TEST_SRC_FILE=../../preprocess_data/${dataset}/testset/src.txt
TEST_TGT_FILE=../../preprocess_data/${dataset}/testset/tgt.txt
