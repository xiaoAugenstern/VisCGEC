...
# Step 3. Inference
MODEL_PATH="/home/xiaoman/project/gec/HandwrittenGEC/gectoolkit/model/MuCGEC/models/seq2seq_lang8+hsk"
#MODEL_PATH=./exps/seq2seq_lang8
RESULT_DIR=$MODEL_PATH/results
mkdir -p $RESULT_DIR

INPUT_FILE=../../data/Visual_text/testset.input # 输入文件
OUTPUT_FILE=$RESULT_DIR"/Visual_test.output" # 输出文件
