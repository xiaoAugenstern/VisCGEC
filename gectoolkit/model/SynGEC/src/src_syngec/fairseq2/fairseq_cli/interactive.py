...
import os
fairseq_path = "/home/xiaoman/project/gec/HandwrittenGEC/gectoolkit/model/SynGEC/src/src_syngec/fairseq2/"
...
def buffered_read(input, buffer_size):
    ...
    # with open(input,'r',encoding='utf-8') as h:   # 如果使用直接读取文件
        for src_str in h:
...
def make_batches(lines, args, task, max_positions, encode_fn):
    ...
    tgt_char_path = '../../preprocess_data/chinese_handwritten_test_with_syntax_bart/test.char.tgt'
    # 打开文件并逐行读取内容，存储在列表中
